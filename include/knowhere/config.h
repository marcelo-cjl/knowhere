...
#define KNOHWERE_DECLARE_CONFIG(CONFIG) KNOWHERE_DECLARE_CONFIG(CONFIG)
 ...
 public:
    ...
    KNOWHERE_DECLARE_CONFIG(BaseConfig) {
        ...
        KNOWHERE_CONFIG_DECLARE_FIELD(index_prefix)
            ...
            .for_train()
            .for_deserialize();
        KNOWHERE_CONFIG_DECLARE_FIELD(build_id)
            .description("build task identifier for log correlation.")
            .allow_empty_without_default()
            .for_train();
